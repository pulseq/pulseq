...
\hypersetup{
    ...
    pdfsubject={MRI},                        % subject of the document
    pdfkeywords={MRI,open format,console}, % list of keywords
    }

...
\midrule
\verb.[DEFINITIONS]. & \verb.<num_defs:int64>. then for each definition: \verb.<key:zero-terminated char[]>. \verb.<count:int8>. \verb.<type:char>. where type is \verb.c., \verb.i. or \verb.f., followed by \verb.<value[count]>. as \verb.char./\verb.int32./\verb.float64.. \\

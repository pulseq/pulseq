...
figure;imab(im3D);colormap('gray');
figure;imab(im3D(:,:,end/2+1));colormap('gray');
figure;imab(im3D(:,:,end/2-1)+im3D(:,:,end/2+0)+im3D(:,:,end/2+1)+im3D(:,:,end/2+2)+im3D(:,:,end/2+3));colormap('gray');

...
%
% When flag_trid = false, TRID labels are silently ignored, allowing the same
...
% check default of sys.flag_trid
disp(['sys.flag_trid is true per default: ' num2str(sys.flag_trid)]);
% sys.flag_trid = false; % uncomment this to ignore seq.addTRID() statements
